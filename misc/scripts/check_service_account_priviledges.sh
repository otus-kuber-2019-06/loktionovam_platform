...
function show_help {
    echo "Check privileges for given service account in given namespace"
    echo "Usage: ${SCRIPT_NAME} -n NAMESPACE -s SERVICE_ACCOUNT"
    echo "Example: check_service_account_priviledges.sh -n default -s system:serviceaccount:dev:jane"
}
